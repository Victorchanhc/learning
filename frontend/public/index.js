  ...
  .addEventListener('submit', async function (event) {
    ...
    if (clubName === 'Manchester United') {
      ...
      result_detail.innerHTML =
        `<div>曼徹斯特聯足球俱樂部簡稱曼聯，是一家位於英國大曼徹斯特郡特拉福德的足球俱樂部，前身為成立於1878年的「紐頓希斯LYR」，1902年改名為曼徹斯特聯。目前於英格蘭超級足球聯賽比賽。球隊主場為老特拉福球場。 曼聯是英格蘭其中一個足球俱樂部，共擁有67項冠軍獎盃，並同時保持英格蘭頂級聯賽及英格蘭社區盾最多冠軍的紀錄。
      ...
      result_detail.innerHTML =
        `<div>利物浦足球俱樂部是一家位於英國英格蘭西北部默西賽德郡港口城市利物浦的英格蘭非職業足球俱樂部。俱樂部成立於1892年6月3日，次年加入英格蘭足球聯賽，自成立以來一直以安菲爾德球場作為主場。 
      ...
      result_detail.innerHTML =
        `<div>曼徹斯特城足球俱樂部，簡稱曼城，是一家位於英國曼徹斯特的足球俱樂部，前身為成立於1880年的「聖馬可的西戈頓」，1887年改名為阿德維克足球俱樂部，1894年改名為「曼徹斯特城」。同年，曼城正式採用天藍色作主場球衣顏色，這也是他們被稱為藍月亮的第一個賽季。目前於英格蘭超級聯賽比賽。球隊主場為阿提哈德球場。 
    ...
    document.querySelector('#saveBtn').addEventListener('click', async () => {
      ...
      const res = await fetch(`/savePhoto`, {
        ...
        body: JSON.stringify({ file_name: fileName.value, club_id : clubId.value })
      });
      window.location.reload()
